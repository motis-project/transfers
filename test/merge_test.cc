...
TEST(transfers, merge_empty_transfer_request_keys) {
  ...
  auto treq_k_a = transfer_request_by_keys{};
  auto treq_k_b = transfer_request_by_keys{};

  auto should_treq_k = transfer_request_by_keys{};
...
TEST(transfers, merge_right_empty_transfer_request_keys) {
  ...
  auto treq_k_a = transfer_request_by_keys{};
  treq_k_a.to_locs_ = {location_key_t{1}, location_key_t{2}, location_key_t{3}};

  auto treq_k_b = transfer_request_by_keys{};

  auto should_treq_k = transfer_request_by_keys{};
  should_treq_k.to_locs_ = {location_key_t{1}, location_key_t{2},
                            location_key_t{3}};
...
TEST(transfers, merge_left_empty_transfer_request_keys) {
  ...
  auto treq_k_a = transfer_request_by_keys{};
  auto treq_k_b = transfer_request_by_keys{};
  treq_k_b.to_locs_ = {location_key_t{1}, location_key_t{2}, location_key_t{3}};
...
TEST(transfers, merge_transfer_request_keys) {
  ...
  auto treq_k_a = transfer_request_by_keys{};
  treq_k_a.from_loc_ = location_key_t{26};
  treq_k_a.profile_ = profile_key_t{1};
  treq_k_a.to_locs_ = {location_key_t{1}, location_key_t{2}, location_key_t{3},
                       location_key_t{5}};

  auto treq_k_b = transfer_request_by_keys{};
  treq_k_b.from_loc_ = location_key_t{26};
  treq_k_b.profile_ = profile_key_t{1};
  treq_k_b.to_locs_ = {location_key_t{3}, location_key_t{4}, location_key_t{5}};

  auto should_treq_k = transfer_request_by_keys{};
  should_treq_k.from_loc_ = location_key_t{26};
  should_treq_k.profile_ = profile_key_t{1};
  should_treq_k.to_locs_ = {location_key_t{1}, location_key_t{2},
                            location_key_t{3}, location_key_t{5},
                            location_key_t{4}};
...
TEST(transfers, merge_different_from_nloc_keys) {
  ...
  treq_k_a.from_loc_ = location_key_t{1};
...
TEST(transfer_result, merge_right_empty_transfer_result) {
  ...
  auto tres_a = transfer_result{};
  tres_a.to_locs_ = {location_key_t{1}, location_key_t{2}};
  tres_a.infos_ = {transfer_info{{}, 1.0}, transfer_info{{}, 2.0}};

  auto tres_b = transfer_result{};

  auto should_tres = transfer_result{};
  should_tres.to_locs_ = {location_key_t{1}, location_key_t{2}};
...
TEST(transfer_result, merge_left_empty_transfer_result) {
  ...
  auto tres_a = transfer_result{};
  auto tres_b = transfer_result{};
  tres_b.to_locs_ = {location_key_t{1}, location_key_t{2}};
...
TEST(transfer_result, merge_transfer_result) {
  ...
  auto tres_a = transfer_result{};
  tres_a.from_loc_ = location_key_t{26};
  tres_a.profile_ = profile_key_t{1};
  tres_a.to_locs_ = {location_key_t{1}, location_key_t{2}, location_key_t{3},
                     location_key_t{5}};
  tres_a.infos_ = {transfer_info{{}, 1.0}, transfer_info{{}, 2.0},
                   transfer_info{{}, 3.0}, transfer_info{{}, 5.0}};

  auto tres_b = transfer_result{};
  tres_b.from_loc_ = location_key_t{26};
  tres_b.profile_ = profile_key_t{1};
  tres_b.to_locs_ = {location_key_t{3}, location_key_t{4}, location_key_t{5}};
  tres_b.infos_ = {transfer_info{{}, 3.0}, transfer_info{{}, 4.0},
                   transfer_info{{}, 5.0}};

  auto should_tres = transfer_result{};
  should_tres.from_loc_ = location_key_t{26};
...
TEST(transfer_Result, merge_id_transfer_results) {
  ...
  tres_b.from_loc_ = location_key_t{26};
  tres_b.profile_ = profile_key_t{1};
  tres_b.to_locs_ = {location_key_t{1}, location_key_t{2}, location_key_t{3},
                     location_key_t{5}};
  tres_b.infos_ = {transfer_info{{}, 1.0}, transfer_info{{}, 2.0},
                   transfer_info{{}, 3.0}, transfer_info{{}, 5.0}};
...
TEST(transfer_result, merge_different_from_nloc_keys) {
  ...
  tres_a.from_loc_ = location_key_t{1};
...
TEST(transfer_result, merge_different_to_nloc_keys_a) {
  ...
  tres_a.to_locs_ = {location_key_t{1}};
...
TEST(transfer_result, merge_different_to_nloc_keys_b) {
  ...
  tres_b.to_locs_ = {location_key_t{1}};
