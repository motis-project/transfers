...
TEST(transfers, merge_right_empty_transfer_request_keys) {
  ...
  auto treq_k_a = transfer_request_by_keys{};
  treq_k_a.to_nloc_keys_ = {nlocation_key_t{1}, nlocation_key_t{2},
                            nlocation_key_t{3}};

  auto treq_k_b = transfer_request_by_keys{};

  auto should_treq_k = transfer_request_by_keys{};
  should_treq_k.to_nloc_keys_ = {nlocation_key_t{1}, nlocation_key_t{2},
                                 nlocation_key_t{3}};
...
TEST(transfers, merge_left_empty_transfer_request_keys) {
  ...
  auto treq_k_a = transfer_request_by_keys{};
  auto treq_k_b = transfer_request_by_keys{};
  treq_k_b.to_nloc_keys_ = {nlocation_key_t{1}, nlocation_key_t{2},
                            nlocation_key_t{3}};
...
TEST(transfers, merge_transfer_request_keys) {
  ...
  treq_k_a.to_nloc_keys_ = {nlocation_key_t{1}, nlocation_key_t{2},
                            nlocation_key_t{3}, nlocation_key_t{5}};

  auto treq_k_b = transfer_request_by_keys{};
  treq_k_b.from_nloc_key_ = nlocation_key_t{26};
  treq_k_b.profile_ = profile_key_t{1};
  treq_k_b.to_nloc_keys_ = {nlocation_key_t{3}, nlocation_key_t{4},
                            nlocation_key_t{5}};
...
TEST(transfer_result, merge_transfer_result) {
  ...
  tres_b.to_nloc_keys_ = {nlocation_key_t{3}, nlocation_key_t{4},
                          nlocation_key_t{5}};
